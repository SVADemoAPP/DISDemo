 ...
 */
package com.gyr.disvisibledemo.rending;
...
import com.gyr.disvisibledemo.framework.sharef.ShaderHelper;
...
public class PlaneRenderer {
    ...
    private float[] mModelMatrix = new float[UtilsCommon.MATRIX_NUM];
    private float[] mModelViewMatrix = new float[UtilsCommon.MATRIX_NUM];
    private float[] mModelViewProjectionMatrix = new float[UtilsCommon.MATRIX_NUM];
    ...
    private void updatePlaneParameters(float[] planeMatrix, float extentX, float extentZ,
        ...
        System.arraycopy(planeMatrix, 0, mModelMatrix, 0, UtilsCommon.MATRIX_NUM);
        if (boundary == null) {
    ...
    public void drawPlanes(Collection<ARPlane> allPlanes, ARPose cameraPose,
        ...
        float cameraView[] = new float[UtilsCommon.MATRIX_NUM];
        ...
        for (SortablePlane sortedPlane : sortedPlanes) {
            ...
            float[] planeMatrix = new float[UtilsCommon.MATRIX_NUM];
